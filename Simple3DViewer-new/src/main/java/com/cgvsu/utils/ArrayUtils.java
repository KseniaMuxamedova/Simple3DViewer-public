...
public class ArrayUtils {
    ...
    */
    ...
    /*public static int[][] intQueueToArray(SimpleLinkedListQueue<SimpleLinkedListQueue<Integer>> listQueue, int n) throws Exception {
        int a = listQueue.count();
        int[][] arr = new int[a][n];
        for (int i = 0; i < a; i++) {
            SimpleLinkedListQueue<Integer> queue = listQueue.remove();
            int b = queue.count();
            for (int j = 0; j < b;j++)
    ...
    public static int[][] intQueueToArraySystem(LinkedBlockingQueue<LinkedBlockingQueue<Integer>> listQueueSystem, int n) throws Exception {
        int a = listQueueSystem.size();
        int[][] arr = new int[a][n];
        for (int i = 0; i < a; i++) {
            LinkedBlockingQueue<Integer> queue = listQueueSystem.remove();
            int b = queue.size();
            for (int j = 0; j < b;j++)
                arr[i][j] = queue.remove();
        }
